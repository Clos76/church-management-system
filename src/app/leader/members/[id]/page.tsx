...
export default function MemberDetailPage() {
  ...
  const [followupForm, setFollowupForm] = useState({
    new_believers_class_1: false,
    new_believers_class_2: false,
    new_believers_class_3: false,
    new_believers_class_4: false,
    pillars_class_1: false,
    pillars_class_2: false,
    pillars_class_3: false,
    pillars_class_4: false,
    pillars_class_5: false,
    pillars_class_6: false,
    pillars_class_7: false,
  });
  ...
  const populateForms = (data: Member) => {
    ...
    //populate form
    setFollowupForm({
      new_believers_class_1: (data as any).new_believers_class_1 || false,
      new_believers_class_2: (data as any).new_believers_class_2 || false,
      new_believers_class_3: (data as any).new_believers_class_3 || false,
      new_believers_class_4: (data as any).new_believers_class_4 || false,
      pillars_class_1: (data as any).pillars_class_1 || false,
      pillars_class_2: (data as any).pillars_class_2 || false,
      pillars_class_3: (data as any).pillars_class_3 || false,
      pillars_class_4: (data as any).pillars_class_4 || false,
      pillars_class_5: (data as any).pillars_class_5 || false,
      pillars_class_6: (data as any).pillars_class_6 || false,
      pillars_class_7: (data as any).pillars_class_7 || false,
    });
  ...
  const handleSave = async (section: ModalType) => {
    ...
    switch (section) {
      ...
      case "medical":
        ...
        break;
      case "followup":
        updates = followupForm; //followup section
        break;
      case "notes":
        updates = notesForm;
        break;
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Follow-up & Classes - ADD THIS ENTIRE SECTION */}
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Track class completion and discipleship progress
                </p>
              </div>
              <button
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-medium text-gray-600">
                    {
                      [
                        followupForm.new_believers_class_1,
                        followupForm.new_believers_class_2,
                        followupForm.new_believers_class_3,
                        followupForm.new_believers_class_4,
                    ...
                    <div key={num} className="flex items-center gap-2">
                      <div
                        className={`w-5 h-5 rounded border-2 flex items-center justify-center ${
                          followupForm[
                            `new_believers_class_${num}` as keyof typeof followupForm
                          ]
                      ...
                      <span className="text-sm text-gray-700">Class {num}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-medium text-gray-600">
                    {
                      [
                        followupForm.pillars_class_1,
                        followupForm.pillars_class_2,
                        followupForm.pillars_class_3,
                        followupForm.pillars_class_4,
                        followupForm.pillars_class_5,
                        followupForm.pillars_class_6,
                        followupForm.pillars_class_7,
                      ].filter(Boolean).length
                    }
                    /7 Complete
                  </span>
                  ...
                  {[1, 2, 3, 4, 5, 6, 7].map((num) => (
                    <div key={num} className="flex items-center gap-2">
                      <div
                        className={`w-5 h-5 rounded border-2 flex items-center justify-center ${
                          followupForm[
                            `pillars_class_${num}` as keyof typeof followupForm
                          ]
      ...
      {activeModal === "followup" && (
        <EditModal
          title="Edit Follow-up & Classes"
          onClose={() => setActiveModal(null)}
          onSave={() => handleSave("followup")}
          saving={saving}
        >
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setFollowupForm({
                          ...followupForm,
                          [`new_believers_class_${num}`]: e.target.checked,
                        })
                      }
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setFollowupForm({
                          ...followupForm,
                          [`pillars_class_${num}`]: e.target.checked,
                        })
                      }
